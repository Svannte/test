...
export default function Contact() {
  ...
  return (
    <div className="font-sans min-h-screen bg-[#0a2540] text-white">
      {/* Header */}
      <header className="p-8 sm:p-20 pb-12">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          ...
          <nav className="hidden sm:flex gap-6">
            ...
            <Link href="/contact" className="text-blue-300">
              Contact
            </Link>
          </nav>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">123 Business Street<br />Suite 100, City, State 12345</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"
                    placeholder="Tell us more about your project, question, or how we can help..."
                  />
                </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-700 p-8 sm:p-20 pt-12">
